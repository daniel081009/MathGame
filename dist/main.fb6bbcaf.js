...
var UI = /*#__PURE__*/function () {
  ...
  _createClass(UI, [{
    key: "AddMainPage",
    value: function AddMainPage() {
      var _this = this;
      this.body.innerHTML = "\n      <h1>ADD Game</h1>\n      <div id=\"start\">Start</div>\n    ";
      document.body.querySelector("#start").onclick = function () {
        _this.Add.score = 0;
        _this.AddGamePage();
    ...
    key: "AddGamePage",
    value: function AddGamePage() {
      var _this2 = this;
      this.body.innerHTML = "\n    <div id= \"plus\">A + B</div>\n    <input id=\"input\" type=\"text\" />\n    ";
      document.getElementById("plus").innerText = this.Add.Make();
      document.getElementById("input").onkeypress = function (e) {
        if (e.key === "Enter") {
          if (_this2.Add.Check(document.getElementById("input").value)) {
            document.getElementById("plus").innerText = _this2.Add.Make();
